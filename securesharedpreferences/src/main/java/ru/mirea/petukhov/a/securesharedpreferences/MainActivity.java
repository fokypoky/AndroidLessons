package ru.mirea.petukhov.a.securesharedpreferences;
...
import ru.mirea.petukhov.a.securesharedpreferences.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            secureSharedPreferences = EncryptedSharedPreferences.create(
                    "secure_share_preferences",
                    mainKeyAlias,
                    getBaseContext(),
                    EncryptedSharedPreferences.PrefKeyEncryptionScheme.AES256_SIV,
                    EncryptedSharedPreferences.PrefValueEncryptionScheme.AES256_GCM
            );
            secureSharedPreferences.edit().putString("ActorName", "Джеффри Дин Морган")
                    .putString("ImageURL", "https://www.vokrug.tv/pic/person/6/7/6/5/6765c875a5e10125af40de15f4d6677c.jpg")
                    .apply();
